...
<body>
	...
	<div class="container">
<a href="%" target="_blank"><img src="logo.png" alt="" width="350px" ></a><br><hr>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					...
					<div class='col-sm-3 col-md-6'>
						...
						<i class='fa fa-home' aria-hidden='true'> Address : </i> $village, $police, <br> $dist
						<br />
						</p>
						<!-- Split button -->
					</div>
